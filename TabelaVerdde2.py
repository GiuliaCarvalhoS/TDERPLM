...
def pOuQ(matriz, tabela):
    primeiroItem6 = matriz[0][0] or matriz[1][0]  # Primeiro item de a E b
    segundoItem6 = matriz[0][1] or matriz[1][1]  # Primeiro item de a E b
    terceiroItem6 = matriz[0][2] or matriz[1][2]
    quartoItem6 = matriz[0][3] or matriz[1][3]
